...
// This closes the clearly-safe supervisor domains. STILL DEFERRED (broad future-FP risk or office/
// corporate borderline): training (rotational-program FP risk), office/corporate supervisors
// (finance/compliance/client-services/project), compound `site X manager` variants.
const SENIOR_INDUSTRY_SUPERVISOR_RE = /\b(production|manufacturing|warehouse|maintenance|quality|distribution|safety|operations|shift|field service|retail|store|floor|center|logistics|materials|shipping|assembly|lab|ramp|cargo|metrology|radiological|mechanic|molding|switchgear|neta|iron|meter|ehs|nurse|clinical|phlebotomy|culinary|food|restaurant|beverage|security)\b.{0,30}\bsupervisor\b|\bsupervisor\b.{0,30}\b(production|manufacturing|warehouse|maintenance|quality|distribution|safety|operations|shift|field service|retail|store|floor|center|logistics|materials|shipping|assembly|lab|ramp|cargo|metrology|radiological|mechanic|molding|switchgear|neta|iron|meter|ehs|nurse|clinical|phlebotomy|culinary|food|restaurant|beverage|security)\b/i;
