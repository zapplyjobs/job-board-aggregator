...
const SENIOR_INDUSTRY_SUPERVISOR_RE = /\b(production|manufacturing|warehouse|maintenance|quality|distribution|safety|operations|shift|field service|retail|store|floor|center)\b.{0,30}\bsupervisor\b|\bsupervisor\b.{0,30}\b(production|manufacturing|warehouse|maintenance|quality|distribution|safety|operations|shift|field service|retail|store|floor|center)\b/i;
