...
const SENIOR_INDUSTRY_SUPERVISOR_RE = /\b(production|manufacturing|warehouse|maintenance|quality|distribution|safety|operations)\b.{0,30}\bsupervisor\b|\bsupervisor\b.{0,30}\b(production|manufacturing|warehouse|maintenance|quality|distribution|safety|operations)\b/i;
