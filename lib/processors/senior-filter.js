...
// STILL DEFERRED (office/corporate borderline — need per-category + operator judgment on whether
// office supervisors are new-grad-appropriate): office/corporate supervisors (finance/compliance/
// client-services/project), compound `site X manager` variants.
const SENIOR_INDUSTRY_SUPERVISOR_RE = /\b(production|manufacturing|warehouse|maintenance|quality|distribution|safety|operations|shift|field service|retail|store|floor|center|logistics|materials|shipping|assembly|lab|ramp|cargo|metrology|radiological|mechanic|molding|switchgear|neta|iron|meter|ehs|nurse|clinical|phlebotomy|culinary|food|restaurant|beverage|security|training)\b.{0,30}\bsupervisor\b|\bsupervisor\b.{0,30}\b(production|manufacturing|warehouse|maintenance|quality|distribution|safety|operations|shift|field service|retail|store|floor|center|logistics|materials|shipping|assembly|lab|ramp|cargo|metrology|radiological|mechanic|molding|switchgear|neta|iron|meter|ehs|nurse|clinical|phlebotomy|culinary|food|restaurant|beverage|security|training)\b/i;
