...
function deduplicateJobs(jobs) {
  ...
  for (const job of jobs) {
    ...
    if (seenById || seenByFp) {
      ...
      // Default anchor is posted_at. For current-run Greenhouse internships, a newer source_updated_at
      // from the official board API may keep a still-live long-cycle internship eligible.
