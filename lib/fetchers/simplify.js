...
const TARGET_COMPANIES = [
  // AGG-SIMPLIFY-EXIT-1 (2026-07-05): removed 14 companies that now have direct fetchers
  // (TikTok, Fortinet, CVS Health, Nokia, onsemi, GM financial, Emerson Electric,
  //  Crane Co., Northwestern Mutual, MKS Instruments, Thales, Moderna, Axiom Space, Intapp).
  // These were pure duplicates — the direct fetcher produces their jobs WITH descriptions.
  ...
  'PNC Financial Services','Boston Scientific',
  ...
  'Cencora', 'Xcel Energy', 'Stantec', 'Berkshire Grey',
  'Faith Technologies','Innovative Defense Technologies','Airbus', 'FMC Corporation','Relay', 'LexisNexis Risk Solutions','JM Family', 'NinjaTrader','Stoke Space', 'Advanced Energy','Varian','Ryan', 'ID.me','Global Partners', 'TWG Global','Air Liquide','Cambridge Associates','Guidewire', 'EBSCO', 'Cambridge Mobile Telematics',];
