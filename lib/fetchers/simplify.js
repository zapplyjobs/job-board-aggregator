...
const TARGET_COMPANIES = [
  ...
  'Berkshire Hathaway Energy',  // 14 US tech internships — energy/data science
  ...
  'KION Group',                 // 8 US tech internships — industrial AI
  ...
  'Honeywell',                  // 8 US tech internships — conglomerate (cyber/ML/SWE)
  'Marmon Holdings',            // 7 US tech internships — conglomerate (data/SWE)
  ...
  'Actian',                              // 6 US tech — AI/database (remote US)
  'HNTB',                                // 5 US tech — AI/data internships
  'Centific',                            // 5 US tech — AI/ML research (remote US)
  'Gelber Group',                        // 5 US tech — SWE/trading (Chicago/Boston)
  'Zillow',                              // 4 US tech — AI scientist PhD interns
  'Bloom Energy',                        // 4 US tech — SWE/ML (San Jose)
  'Ambarella',                           // 4 US tech — SWE interns (US)
  ...
  'Kioxia',                              // 4 US tech — semiconductor memory (Santa Clara)
  'Kodiak Robotics',                     // 4 US tech — autonomous driving (ML/AI)
  'd-Matrix',                            // ~3 US tech — AI chips (Santa Clara)
  'onsemi',                              // ~3 US tech — semiconductor (AZ/TX)
  'Dexcom',                              // 3 US tech — medical devices SWE
  ...
  'Bose',                              // 4 US — ML/DSP co-ops + research intern, Framingham MA
  ...
  'Onto Innovation',                   // 6 US — optical/data analytics interns, Milpitas CA
  'Varda Space',                       // 5 US — mission ops/software interns, El Segundo CA
  'Axos Bank',                         // 5 US — SWE/data science interns, San Diego CA
  'Draper',                            // 5 US — SWE/co-op, Cambridge MA
  'Kaiser Permanente',                 // 5 US — process improvement/data interns, CA/OR
  'XPENG Motors',                      // 4 US — AI/research scientist interns, Santa Clara CA
  ...
  'BillionToOne',                      // 3 US — AI eng/PM interns, Menlo Park CA
  'BeOne',                             // 3 US — data/BI interns, San Carlos CA/remote
  'Vertex Pharmaceuticals',            // 3 US — data eng co-ops, Boston/San Diego
  'Highmark Health',                   // 2 US — SWE interns, Pittsburgh/remote
  'SWBC',                              // 2 US — SWE interns, San Antonio TX
  'Becton Dickinson',                  // 1 US — data analytics intern
  // F54 (SUP-INTERN-1 expansion): Unfetchable ATS, verified US tech internships
  'ABB',                        // 5 US tech internships — Swiss-Swedish industrial/robotics (San Jose CA)
  'CME Group',                  // 4 US tech internships — quant/data science (Chicago)
  ...
  'Schweitzer Engineering Laboratories', // 3 US tech internships — power systems SWE (Moscow ID)
  ...
  'Keysight Technologies',      // 64 US tech — electronic test/measurement (Santa Rosa CA)
  'Paccar',                     // 36 US tech — truck manufacturer (Bellevue WA)
  'Parsons',                    // 29 US tech — defense/engineering (Centreville VA)
  'BorgWarner',                 // 23 US tech — automotive supplier (Auburn Hills MI)
  ...
  'Vertiv',                     // 21 US tech — data center infrastructure (Westerville OH)
  'VSP Vision',                 // 18 US tech — healthcare IT (Rancho Cordova CA)
  'Westinghouse Electric Company', // 18 US tech — nuclear energy (Cranberry Township PA)
  'PTC',                        // 17 US tech — industrial IoT/CAD software (Boston MA)
  'Teledyne',                   // 17 US tech — aerospace/defense instrumentation (Thousand Oaks CA)
  'HARMAN International',       // 16 US tech — automotive electronics (Stamford CT)
  'Zebra Technologies',         // 15 US tech — enterprise computing (Lincolnshire IL)
  'Fresenius Medical Care',     // 15 US tech — healthcare/dialysis IT (Waltham MA)
  'Dover',                      // 15 US tech — industrial conglomerate (Downers Grove IL)
  'Hewlett Packard (HP)',       // 15 US tech — PC/printer tech (Houston TX)
  'Nutanix',                    // 14 US tech — cloud computing (San Jose CA). Ashby API-gated.
  'PG&E',                       // 14 US tech — utility/energy tech (San Francisco CA)
  'Apex Fintech Solutions',     // 13 US tech — fintech (Dallas TX)
  'Qorvo',                      // 13 US tech — semiconductor (Greensboro NC)
  'Flagship Pioneering',        // 13 US tech — biotech VC (Cambridge MA)
  'Fortive',                    // 13 US tech — industrial conglomerate (Everett WA)
  'AstraZeneca',                // 13 US tech — pharma IT (Wilmington DE)
  'SAS',                        // 13 US tech — analytics software (Cary NC). NOT the GH security company.
  'Premier',                    // 13 US tech — healthcare tech (Charlotte NC)
  'Corsair',                    // 13 US tech — gaming hardware (Milpitas CA)
  'Avnet',                      // 13 US tech — electronics distributor (Phoenix AZ)
  'LabCorp',                    // 12 US tech — diagnostics/lab IT (Burlington NC)
  ...
  'Baxter International',       // 12 US tech — medical devices (Deerfield IL)
  'Field AI',                   // 12 US tech — robotics/autonomy (Brisbane CA)
  'HERE Technologies',          // 12 US tech — maps/location tech (Chicago IL)
  'The Coca-Cola Company',      // 12 US tech — consumer engagement IT (Atlanta GA)
  // F62 (SUP-INTERN-5): Batch 2 — STANDARD yield (5-9 US tech internships)
  // All verified: unfetchable ATS, US-based, real tech internship listings on SimplifyJs
  'Regal Rexnord', 'Wex', 'Siemens', 'Viavi Solutions', 'ICF International',
  'Plexus', 'Symbotic', 'CenturyLink', 'Chubb', 'HCSC',
  'Waters Corporation', 'Bio-Techne', 'Calix', 'OCLC', 'Ensono',
  'Nissan Global', 'Lennox International', 'American Century Investments', 'Clarios', 'Rambus',
  'Cohesity', 'Daimler Truck', 'Rheem', 'Eversource Energy', 'Wing',
  '7-Eleven', 'Nelnet', 'DigiKey', 'Signify', 'Ford Motor Company',
  'Stanley Black & Decker', 'Abacus Insights', 'The Allen Institute for AI', 'Belden', 'Nidec',
  'Paramount Global', 'Crane Co.', 'Vanderlande Industries',
  'ZOLL Medical Corporation', 'Northwestern Mutual', 'Norfolk Southern', 'Dominion Energy',
  'GE Appliances', 'MKS Instruments', 'ADT', 'Thales', 'ALSO',
  'Nasdaq', 'CommScope', 'Empower', 'First American', 'DiDi Global',
  'Woven', 'Blackberry', 'Voyager Technologies',
  'Inogen', 'Cox', 'Corning', 'Barry-Wehmiller', 'Bristol Myers Squibb',
  'Lendbuzz', 'Harris Computer', 'Edison International', 'GoDaddy', 'McKesson',
  'Stifel', 'Inspire Medical Systems', 'Harbinger Motors', 'Dow Chemical Company',
  'Semtech', 'Wabtec', 'Smith+Nephew', 'Camping World', 'Evolve Technology',
  'Archer', 'Ribbon', 'Assurant', 'Impinj', 'Live Nation Entertainment',
  'Cencora', 'Xcel Energy', 'Moderna', 'Stantec', 'Berkshire Grey',
  'Faith Technologies', 'Zeiss', 'MFS',
  'Innovative Defense Technologies', 'Flowserve', 'Airbus', 'FMC Corporation',
  'Nestle', 'Relay', 'LexisNexis Risk Solutions', 'Two Six Technologies',
  'JM Family', 'NinjaTrader', 'Vistra', 'Stoke Space', 'Advanced Energy',
  'Modernizing Medicine', 'Varian', 'Transcarent',
  'Integration Innovation (i3)', 'Ryan', 'ID.me', 'Cintas',
  'SK hynix', 'USAFacts', 'Uhaul', 'Axiom Space', 'Atlassian',
  'Global Partners', 'Intapp', 'TWG Global', 'Plug Power', 'Air Liquide',
  'EverCommerce', 'Cambridge Associates', 'Ryder System', 'Strategic Education',
  'Guidewire', 'EBSCO', 'Cambridge Mobile Telematics', 'Scout Motors',
  'Terran Orbital', 'Torch Technologies',
];
