...
const TARGET_COMPANIES = [
  ...
  // All verified: unfetchable ATS, US-based, real tech internship listings on SimplifyJs
  'Regal Rexnord', 'Wex', 'Siemens', 'Viavi Solutions','Plexus','Chubb','Waters Corporation', 'Bio-Techne','Nissan Global', 'Lennox International', 'American Century Investments', 'Clarios', 'Rambus','Daimler Truck','Eversource Energy','Nelnet', 'DigiKey', 'Signify', 'Ford Motor Company','The Allen Institute for AI','Nidec',
  'Paramount Global', 'Crane Co.', 'Vanderlande Industries','Northwestern Mutual','MKS Instruments','Thales', 'ALSO',
  'Nasdaq','First American', 'DiDi Global',
  'Woven','Voyager Technologies','Cox', 'Corning', 'Barry-Wehmiller','Harris Computer','McKesson',
  'Stifel','Dow Chemical Company',
  'Semtech', 'Wabtec', 'Smith+Nephew','Live Nation Entertainment',
