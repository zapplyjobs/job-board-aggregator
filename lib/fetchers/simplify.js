...
const TARGET_COMPANIES = [
  ...
  'Faith Technologies','Innovative Defense Technologies','Airbus', 'FMC Corporation','JM Family', 'NinjaTrader','Stoke Space', 'Advanced Energy','Ryan', 'ID.me','Global Partners', 'TWG Global','Cambridge Associates','Guidewire', 'EBSCO', 'Cambridge Mobile Telematics',  // AGG-SIMPLIFY-EXIT-1 (2026-07-05): reverted — simplify URLs had wrong ATS classification
  // These companies' career sites don't match the ATS the simplify data claimed.
  // Need per-company research to find the correct ATS before re-adding to company-list.
  'University of Texas at Austin', 'Air Liquide', 'Penn State University',
  'McKesson', 'PNC Financial Services', 'Cox', 'Teledyne',
  'Hewlett Packard (HP)', 'Stryker', 'Varian',
  'Uncountable', 'Cirrus Logic', 'Woven', 'Robert Bosch Venture Capital',
];
