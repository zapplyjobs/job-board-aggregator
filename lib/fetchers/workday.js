...
async function buildFamilyCache(tenants, cacheDir, options = {}) {
    ...
    // Prioritize uncached tenants first, then older cached tenants. This lets a bounded
    // per-run budget steadily expand tenant coverage instead of repeatedly refreshing the
    // same early tenants forever.
