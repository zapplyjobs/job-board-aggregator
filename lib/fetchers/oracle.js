...
const TECH_DETAIL_TITLE_RE = /\b(ai|analytics?|automation|cloud|controls?|data|database|developer|electrical|engineer(?:ing)?|facilities|hardware|information technology|it|linux|mechanical|mixed signal|network|plc|python|rpa|security|software|systems?|technical|technology|test)\b/i;
...
function oracleDetailPriorityScore(target) {
  ...
  let score = 0;
  if (TECH_DETAIL_TITLE_RE.test(title)) score += 100;
