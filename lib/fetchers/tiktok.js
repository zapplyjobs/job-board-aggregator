...
// AGG-GIANTCANADA-1: Added 'CT|7' (Canada country-level code from lifeattiktok.com search URL).
// Format confirmed: search page uses location_code_list=CT%7C7 for Canada.
// US codes use CT_ prefix (city-level), Canada code uses CT| prefix (country-level).
// Both are strings in the same array — API matches against its database regardless of format.
const US_CITY_CODES = [
  ...
  'CT|7', // Canada country-level code
];
