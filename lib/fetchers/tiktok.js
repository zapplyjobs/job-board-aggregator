...
async function fetchAllTiktokJobs() {
  ...
  // AGG-GIANTCANADA-1: Canada location code research COMPLETE.
  // Tested CT|7 and CT_7 in isolated API probes — both accepted (code=0) but return 0 jobs.
  // The search page URL format (CT%7C7) does NOT match the API's internal location code system.
  // US codes use CT_ prefix (city-level). Canada's correct API code is unknown.
  // Further research needed: reverse-engineer API code system or find documentation.
  const allJobs = [];
